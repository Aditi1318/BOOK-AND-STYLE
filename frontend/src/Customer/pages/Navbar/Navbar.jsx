import {Avatar, Badge, Button, IconButton, InputAdornment, Menu, MenuItem, OutlinedInput} from "@mui/material";
        ...
        <div className={`z-50  px-6  flex items-center justify-between  py-2 fixed top-0 left-0 right-0 bg-white`}>
            <div className="flex items-center gap-10">
                ...
                <div className="lg:flex items-center gap-5 hidden">
                    <h1 className="cursor-pointer hover:text-primary-color" onClick={() => navigate("/")}>
                        Home
                    </h1>
                </div>
            </div>
