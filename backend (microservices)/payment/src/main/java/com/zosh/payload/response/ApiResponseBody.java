...
public class ApiResponseBody<T> {
    ...
    // Constructor used in your original code - initializes timestamp from LocalDateTime
    ...
    // Constructor used in your original code - initializes timestamp from ZonedDateTime
    ...
    // No setter for `data` because it's `final`
}
